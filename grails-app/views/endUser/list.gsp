			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="fullname" title="${message(code: 'endUser.fullname.label', default: 'Fullname')}" />
					
						<g:sortableColumn property="username" title="${message(code: 'endUser.username.label', default: 'Username')}" />
